...
export const FOODS = [
  ...
  { id: 'sedano', name: 'Sedano', emoji: '🥬', kcal: 16, protein: 0.7, carbs: 3, fat: 0.2, fiber: 1.6, category: 'Verdura' },
  { id: 'aglio', name: 'Aglio', emoji: '🧄', kcal: 149, protein: 6.4, carbs: 33.1, fat: 0.5, fiber: 2.1, category: 'Verdura' },
  { id: 'porri', name: 'Porri', emoji: '🥬', kcal: 61, protein: 1.5, carbs: 14.2, fat: 0.3, fiber: 1.8, category: 'Verdura' },
  { id: 'asparagi', name: 'Asparagi', emoji: '🥬', kcal: 20, protein: 2.2, carbs: 3.9, fat: 0.1, fiber: 2.1, category: 'Verdura' },
  { id: 'bietole', name: 'Bietole', emoji: '🥬', kcal: 19, protein: 1.8, carbs: 3.7, fat: 0.2, fiber: 1.6, category: 'Verdura' },
  { id: 'cavolo-cappuccio', name: 'Cavolo cappuccio', emoji: '🥬', kcal: 25, protein: 1.3, carbs: 5.8, fat: 0.1, fiber: 2.5, category: 'Verdura' },
  { id: 'cavolo-nero', name: 'Cavolo nero', emoji: '🥬', kcal: 49, protein: 4.3, carbs: 8.8, fat: 0.9, fiber: 3.6, category: 'Verdura' },
  { id: 'verza', name: 'Verza', emoji: '🥬', kcal: 27, protein: 2, carbs: 6.1, fat: 0.1, fiber: 3.1, category: 'Verdura' },
  { id: 'cavoletti-bruxelles', name: 'Cavoletti di Bruxelles', emoji: '🥬', kcal: 43, protein: 3.4, carbs: 8.9, fat: 0.3, fiber: 3.8, category: 'Verdura' },
  { id: 'rucola', name: 'Rucola', emoji: '🥬', kcal: 25, protein: 2.6, carbs: 3.7, fat: 0.7, fiber: 1.6, category: 'Verdura' },
  { id: 'radicchio', name: 'Radicchio', emoji: '🥬', kcal: 23, protein: 1.4, carbs: 4.5, fat: 0.3, fiber: 1.5, category: 'Verdura' },
  { id: 'indivia', name: 'Indivia', emoji: '🥬', kcal: 17, protein: 1.3, carbs: 3.4, fat: 0.2, fiber: 3.1, category: 'Verdura' },
  { id: 'scarola', name: 'Scarola', emoji: '🥬', kcal: 25, protein: 1.7, carbs: 4.7, fat: 0.3, fiber: 3.1, category: 'Verdura' },
  { id: 'ravanelli', name: 'Ravanelli', emoji: '🥬', kcal: 16, protein: 0.7, carbs: 3.4, fat: 0.1, fiber: 1.6, category: 'Verdura' },
  { id: 'barbabietola', name: 'Barbabietola', emoji: '🥬', kcal: 43, protein: 1.6, carbs: 9.6, fat: 0.2, fiber: 2.8, category: 'Verdura' },
  { id: 'rape', name: 'Rape', emoji: '🥬', kcal: 28, protein: 0.9, carbs: 6.4, fat: 0.1, fiber: 1.8, category: 'Verdura' },
  { id: 'fagiolini', name: 'Fagiolini', emoji: '🫛', kcal: 31, protein: 1.8, carbs: 7, fat: 0.2, fiber: 3.4, category: 'Verdura' },
  { id: 'carciofi', name: 'Carciofi', emoji: '🥬', kcal: 47, protein: 3.3, carbs: 10.5, fat: 0.2, fiber: 5.4, category: 'Verdura' },
  { id: 'sedano-rapa', name: 'Sedano rapa', emoji: '🥬', kcal: 42, protein: 1.5, carbs: 9.2, fat: 0.3, fiber: 1.8, category: 'Verdura' },
  { id: 'cicoria', name: 'Cicoria', emoji: '🥬', kcal: 23, protein: 1.7, carbs: 4.7, fat: 0.3, fiber: 4, category: 'Verdura' },
  { id: 'cavolo-rosso', name: 'Cavolo rosso', emoji: '🥬', kcal: 31, protein: 1.4, carbs: 7.4, fat: 0.2, fiber: 2.1, category: 'Verdura' },
  { id: 'germogli-soia', name: 'Germogli di soia', emoji: '🌱', kcal: 30, protein: 3, carbs: 5.9, fat: 0.2, fiber: 1.8, category: 'Verdura' },
  { id: 'mais-dolce', name: 'Mais dolce', emoji: '🌽', kcal: 86, protein: 3.3, carbs: 19, fat: 1.4, fiber: 2.7, category: 'Verdura' },
  { id: 'songino', name: 'Songino', emoji: '🥬', kcal: 21, protein: 2, carbs: 3.6, fat: 0.4, fiber: 1.9, category: 'Verdura' },
  { id: 'topinambur', name: 'Topinambur', emoji: '🥔', kcal: 73, protein: 2, carbs: 17.4, fat: 0, fiber: 1.6, category: 'Verdura' },
  { id: 'funghi-porcini', name: 'Funghi porcini', emoji: '🍄', kcal: 26, protein: 3.1, carbs: 3, fat: 0.3, fiber: 2, category: 'Verdura' },
  { id: 'peperoncino-fresco', name: 'Peperoncino fresco', emoji: '🌶️', kcal: 40, protein: 1.9, carbs: 8.8, fat: 0.4, fiber: 1.5, category: 'Verdura' },

  // CARNE (nuovi tagli)
  { id: 'filetto-manzo', name: 'Filetto di manzo', emoji: '🥩', kcal: 143, protein: 21.4, carbs: 0, fat: 5.8, fiber: 0, category: 'Carne' },
  { id: 'controfiletto-manzo', name: 'Controfiletto di manzo', emoji: '🥩', kcal: 170, protein: 21, carbs: 0, fat: 8.5, fiber: 0, category: 'Carne' },
  { id: 'agnello', name: 'Agnello (cosciotto magro)', emoji: '🍖', kcal: 162, protein: 20.5, carbs: 0, fat: 8.1, fiber: 0, category: 'Carne' },
  { id: 'coniglio', name: 'Coniglio', emoji: '🐇', kcal: 136, protein: 21.8, carbs: 0, fat: 5, fiber: 0, category: 'Carne' },
  { id: 'pancetta', name: 'Pancetta', emoji: '🥓', kcal: 361, protein: 12, carbs: 0, fat: 34, fiber: 0, category: 'Carne' },
  { id: 'speck', name: 'Speck', emoji: '🥓', kcal: 232, protein: 21, carbs: 0.5, fat: 16, fiber: 0, category: 'Carne' },
  { id: 'salame', name: 'Salame', emoji: '🥓', kcal: 380, protein: 22, carbs: 1, fat: 31, fiber: 0, category: 'Carne' },
  { id: 'mortadella', name: 'Mortadella', emoji: '🥓', kcal: 288, protein: 15.7, carbs: 2, fat: 25.2, fiber: 0, category: 'Carne' },
  { id: 'prosciutto-crudo', name: 'Prosciutto crudo (sgrassato)', emoji: '🥓', kcal: 159, protein: 25.9, carbs: 0, fat: 6, fiber: 0, category: 'Carne' },
